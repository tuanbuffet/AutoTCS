...
import static KeyWords.Browser.*;
import java.time.Duration;
import java.util.List;

public class WebUI extends Browser {
    public static WebDriver driver;

    public static   void openBrowser(){
        System.out.println("Start Chrome browser form BaseTest......");
    ...
    public static void closeBrowser() throws InterruptedException {
        Thread.sleep(5000);
        System.out.println("Close Chrome browser form BaseTest......");
        driver.quit();
    }
